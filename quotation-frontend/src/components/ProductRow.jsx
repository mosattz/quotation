    ...
    <tr className="bg-white">
      <td className="px-6 py-3">
        <div className="rounded-xl border border-slate-200/70 bg-white/80 px-3 py-3">
          ...
          <input
            className="mt-2 w-full border-b border-slate-200 bg-transparent pb-2 text-sm text-slate-800 outline-none transition focus:border-slate-900"
      ...
      {isAdmin && (
        <td className="px-6 py-3">
          <div className="rounded-xl border border-slate-200/70 bg-white/80 px-3 py-3">
            ...
            <div className="mt-2 border-b border-slate-200 pb-2 text-sm text-slate-800">
              {item.unit || "—"}
            </div>
          </div>
        </td>
      ...
      {isAdmin && (
        <td className="px-6 py-3">
          <div className="rounded-xl border border-slate-200/70 bg-white/80 px-3 py-3">
            ...
            <div className="mt-2 border-b border-slate-200 pb-2 text-right text-sm text-slate-800">
      ...
      <td className="px-6 py-3">
        <div className="flex justify-end">
          <div className="w-full max-w-[140px] rounded-xl border border-slate-200/70 bg-white/80 px-3 py-3">
            <label className="text-[10px] font-semibold uppercase tracking-wide text-slate-500">
              Qty
            </label>
            <input
              type="number"
              min="0"
              className="mt-2 w-full border-b border-slate-200 bg-transparent pb-2 text-right text-sm text-slate-800 outline-none transition focus:border-slate-900"
              placeholder="0"
              value={item.qty ?? ""}
